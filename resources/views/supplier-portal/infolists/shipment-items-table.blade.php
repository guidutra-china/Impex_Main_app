@php
    $record = $getRecord();
    $items = $record->items()->with(['proformaInvoiceItem.product', 'purchaseOrderItem.purchaseOrder'])->get();
@endphp
...
@else
    <p class="text-sm text-gray-500 dark:text-gray-400 italic">No items in this shipment.</p>
@endif
