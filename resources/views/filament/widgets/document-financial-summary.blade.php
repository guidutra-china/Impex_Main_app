                                ...
                                <tr :class="index % 2 === 1 ? 'border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02]' : 'border-b border-gray-100 dark:border-white/5'">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-2.5">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <template x-if="item.shipment_ref">
                                                <span class="inline-flex items-center rounded-md bg-info-100 px-2 py-0.5 text-[0.65rem] font-medium text-info-700 dark:bg-info-500/20 dark:text-info-400" x-text="item.shipment_ref"></span>
                                            </template>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-2.5">
