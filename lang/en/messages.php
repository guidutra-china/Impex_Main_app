...
return [
    'excel_archived' => 'Excel archived in Documents',
    'document_version_created' => 'Version :version created: :name',
    ...
    'shipment_delete_blocked_title' => 'Shipment cannot be deleted',
    'shipment_delete_blocked_body' => 'These schedule items already have payments allocated. Reallocate or reverse them first:',
    ...
    'update_confirmed_pos' => 'Update already confirmed/in-production POs',
    'confirmed_pos_need_checkbox' => '**:count confirmed/in-production PO(s)** will only be updated if you tick ":label": :names',
    'pos_skipped_shipped_items' => 'Items not updated (quantity below what shipments have allocated): :items',
    'check_payment_schedules' => 'Confirmed POs were updated — review the payment schedules.',
    'shipment_payments_client_title' => 'Client receivables',
    'shipment_payments_supplier_title' => 'Supplier payments',
    'shipment_payments_supplier_own_title' => 'Payments for this shipment',
    'shipment_payments_paid' => 'paid',
    'shipment_payments_paid_label' => 'Paid',
    'shipment_payments_outstanding' => 'Outstanding',
    'shipment_payments_total' => 'Total',
    'shipment_payments_prorated' => 'prorated',
    'shipment_payments_due' => 'due',
    'shipment_payments_status_paid' => 'paid',
    'shipment_payments_status_partial' => 'partial',
    'shipment_payments_status_overdue' => 'overdue',
    'shipment_payments_status_pending' => 'pending',
    'shipment_payments_no_condition' => 'Other',
    ...
    'fx_rate_skipped_same_currency' => ':count item(s) skipped: their cost is already in :currency, the PI currency, so the rate is always 1.',
    'fx_rate_no_items_updated' => 'No item was changed',
