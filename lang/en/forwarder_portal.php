...
return [
    'shipment' => [
        ...
        'update_schedule' => 'Update ETD/ETA',
        'update_schedule_heading' => 'Update schedule — :ref',
        'update_schedule_submit' => 'Save',
        'update_schedule_done' => 'Schedule updated.',
        'change_status' => 'Change status',
        'change_status_heading' => 'Change status — :ref',
        'change_status_submit' => 'Change to :status',
        'change_status_done' => 'Status updated to :status.',
        'status_flow_previous' => 'Previous',
        'status_flow_current' => 'Current',
        'status_flow_next' => 'Next',
        'status_flow_none' => 'No status change is available for this shipment.',
        'status_flow_completed' => 'The shipment has arrived — there is no next status. Marked as Arrived by mistake?',
        'revert_to_in_transit' => 'Revert to In Transit',
        'revert_confirm' => 'The shipment will go back to In Transit and the actual arrival date will be cleared.',
        'revert_done' => 'Status reverted to In Transit.',
