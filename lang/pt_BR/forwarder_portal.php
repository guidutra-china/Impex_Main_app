...
return [
    'shipment' => [
        ...
        'update_schedule' => 'Atualizar ETD/ETA',
        'update_schedule_heading' => 'Atualizar datas — :ref',
        'update_schedule_submit' => 'Salvar',
        'update_schedule_done' => 'Datas atualizadas.',
        'change_status' => 'Alterar status',
        'change_status_heading' => 'Alterar status — :ref',
        'change_status_submit' => 'Mudar para :status',
        'change_status_done' => 'Status atualizado para :status.',
        'status_flow_previous' => 'Anterior',
        'status_flow_current' => 'Atual',
        'status_flow_next' => 'Próximo',
        'status_flow_none' => 'Nenhuma mudança de status disponível para este embarque.',
        'status_flow_completed' => 'O embarque chegou — não há próximo status. Marcou Chegada por engano?',
        'revert_to_in_transit' => 'Reverter para Em Trânsito',
        'revert_confirm' => 'O embarque voltará para Em Trânsito e a data de chegada real será limpa.',
        'revert_done' => 'Status revertido para Em Trânsito.',
