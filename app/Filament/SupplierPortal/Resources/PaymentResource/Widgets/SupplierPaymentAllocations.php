...
namespace App\Filament\SupplierPortal\Resources\PaymentResource\Widgets;
...
class SupplierPaymentAllocations extends Widget
{
    protected static bool $isLazy = false;
    protected string $view = 'supplier-portal.widgets.payment-allocations';
