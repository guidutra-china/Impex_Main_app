...
use App\Filament\SupplierPortal\Resources\ProductResource\Pages;
use BackedEnum;
...
class ProductResource extends Resource
{
    ...
    /**
     * Sort: Dashboard = -2, Products = -1, then PurchaseOrders = 1, Shipments = 2, Payments = 1 (Finance group)
     * Products appears right after Dashboard and before Purchase Orders.
     */
    ...
    {
        return auth()->user()?->can('supplier-portal:view-products') ?? false;
    }
    ...
    /**
     * Scope the query to only the current tenant's supplier-role products.
     */
    ...
    {
        $showFinancial = auth()->user()?->can('supplier-portal:view-financial-summary') ?? false;
            ...
            Section::make('Pricing & Terms')
                ->schema([
                    TextEntry::make('unit_price')
                        ...
                        ->visible(fn () => auth()->user()?->can('supplier-portal:view-financial-summary')),
