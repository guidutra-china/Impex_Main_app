...
class ReferenceDataController
{
     ...
     * codes as well so any country is reachable. The `name` here is a neutral
     * English fallback: the PWA localizes the label client-side from the ISO
     * code via Intl.DisplayNames, following the user's locale.
     *
